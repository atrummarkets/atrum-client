...
if (cmd === "status") {
  ...
  const btnSelector = `#notes-body button[data-act="bet"][data-side="${side === "YES" ? "1" : "2"}"]`;
  ...
  await page.click("#refresh-notes");
  await page.waitForSelector('#notes-body button[data-act="redeem"]', { timeout: 20000 });
  await page.click('#notes-body button[data-act="redeem"]');
